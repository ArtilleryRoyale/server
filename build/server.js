        ...
        try {
            ...
            if (messageObject.n.length > 0) {
                ...
                for (let snapshot of messageObject.n) {
                    Debug("[" + Who(isOwner) + "]\t\tSnapshot " + MethodIdentifier_1.debugIntToObject(snapshot.o) + "→" + MethodIdentifier_1.debugIntToMethod(snapshot.m) + " 🕑 " + (snapshot.t < 0 ? "INSTANT‼️" : DebugRoundTime(snapshot.t)));
                }
            }
